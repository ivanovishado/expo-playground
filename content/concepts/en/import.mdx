...
- **Named imports** use curly braces: `{ View, Text }` — you pick specific exports from the module.
- **Default imports** have no braces: `import React from "react"` — the module chose one "main" export.
