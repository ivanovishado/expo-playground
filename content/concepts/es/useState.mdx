...
2. **Una función para actualizarlo** (`setCount`) — llámala para cambiar el valor y volver a renderizar.
...
Las actualizaciones de estado son **asíncronas**: el nuevo valor estará disponible en el _siguiente_ renderizado, no justo después de llamar al setter.
