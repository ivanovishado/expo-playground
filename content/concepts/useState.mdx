...
2. **A setter function** (`setCount`) — call this to update the value and re-render.
...
State updates are **asynchronous** — the new value is available on the _next_ render, not immediately after calling the setter.
